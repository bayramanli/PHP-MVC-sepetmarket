...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="/">Sepet Market</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/basket">Sepetim</a>
                    </li>
                </ul>
                <div>
                    <?php if (isset($_SESSION["users"])) { ?>
                        <a href="/logout" class="btn btn-primary btn-sm">Çıkış Yap</a>
                    <?php } else { ?>
                        <a href="/login" class="btn btn-primary btn-sm">Giriş Yap</a>
                    <?php } ?>
                    <a href="/basket" class="btn btn-success btn-sm">
                        <span class="bi bi-cart-plus-fill cart-icon"> Sepete Git</span>
